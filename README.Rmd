...
The first step in the analysis pipeline is manual **C**ategorization of the feature set to (i) current clinical measures, (ii) potential biomarkers and (iii) assigned diagnosis.  
